...
public class Operations {
    ...
    public static float validateDataDivision(String inputValue){
     ...
     public static int validateDataProduct(String inputValue){
    ...
    public static float division(float dividen, float divisor){
     ...
     public static int multiplication(String stringOriginalValue, String stringTimesToAdd){
        
        int originalValue= Operations.validateDataProduct(stringOriginalValue);
        int timesToAdd= Operations.validateDataProduct(stringTimesToAdd);
